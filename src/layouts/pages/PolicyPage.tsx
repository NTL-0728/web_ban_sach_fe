		...
		<div className='container mt-5'>
			...
			<p>
				...
				<a href='#!chinh-sach-doi-tra-hang'>
					<strong>luandan.com/chinh-sach-doi-tra-hang</strong>
				</a>{" "}
			...
			<ul>
				<li>
					<p>Quý khách vui lòng thông báo về cho Luân đần ngay khi:</p>
					<p>
						{" "}
				...
				<li>
					<p>
						Sau khi Luân đần xác nhận mail tiếp nhận yêu cầu kiểm tra xử
						lý, Luân đần sẽ liên hệ đến quý khách để xác nhận thông tin
						hoặc nhờ bổ sung thông tin (nếu có). Trường hợp không liên hệ
						được Luân đần rất tiếc xin được phép từ chối xử lý yêu cầu.
						Thời gian Luân đần liên hệ trong giờ hành chính tối đa 3 lần
			...
			<p>
				...
				<strong>Luân đần</strong> trong vòng 30 ngày kể từ khi nhận hàng với
			...
			<br />
			<p>
			<strong>Luân đần</strong> hỗ trợ đổi/ trả sản phẩm cho quý khách nếu:
			</p>
			<ul>
				<li>
			...
			<ul>
				<li>
					<p>
						...
						<strong>cskh@luandan.com.vn</strong> với tiêu đề{" "}
			...
			<ul>
				<li>
					Để đảm bảo quyền lợi khách hàng và để <strong>Luân đần</strong> có
					...
					clip từ quý khách, <strong>Luân đần</strong> xin phép từ chối hỗ
					trợ.
				</li>
			</ul>
			<table
			...
			>
				<tbody>
					...
					<tr>
						...
						<td>
							<p>Luân đần có sản phẩm→ đổi mới cùng sản phẩm</p>
							<p>
							Luân đần hết hàng→ Hoàn tiền hoặc quý khách có thể chọn
								mặt hàng khác tại website{" "}
								<span style={{ textDecoration: "underline" }}>
									<a href='#!'>www.LuanDan</a>
								</span>
								.
							</p>
					...
					<tr>
						...
						<td>
							...
							<p>
								**Lưu ý: Luân đần rất tiếc sẽ không hỗ trợ hoàn lại chi
