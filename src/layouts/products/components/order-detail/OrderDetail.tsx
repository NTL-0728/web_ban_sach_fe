    ...
    <>
      ...
      <div className="row">
        <div className="col-lg-3 col-md-6 col-sm-12">
          <p className="mt-2">
            Mã đơn hàng: <strong className="ms-2">{props.order.idOrder}</strong>
          </p>
          <p>
            Ngày mua:
        ...
        <div className="col-lg-4 col-md-6 col-sm-12">
          ...
          <p>
            Địa chỉ giao hàng:
            <strong className="ms-2">{props.order.deliveryAddress}</strong>
          </p>
          <p>
            Số điện thoại:
        ...
        <div className="col">
          <StepperComponent steps={props.steps} activeStep={props.activeStep} />
        </div>
      </div>
      <hr className="mt-3" />
      <p>
