      ...
      <div className="container-book container mb-5 py-5 px-5 bg-light">
        <div className="row">
          ...
          <div className="col-8 px-5">
            <Skeleton className="my-3" variant="rectangular" height={100} />
          ...
          <div className="container p-2 bg-white my-3 rounded">
            <div className="row mt-4 mb-4">
                ...
                >
                  {images?.map((image, index) => (
                    ...
                    >
                      <img
                        alt=""
                        src={image.dataImage ? image.dataImage : image.urlImage}
                      />
                    </div>
                  ))}
                </Carousel>
              ...
              <div className="col-lg-8 col-md-8 col-sm-12 px-5">
                ...
                <div className="d-flex align-items-center">
                  <div className="d-flex align-items-center">
                    <RatingStar readonly={true} ratingPoint={book.avgRating} />

                    <p className="text-danger ms-2 mb-0">({book.avgRating})</p>
                  </div>
                  <div className="d-flex align-items-center">
                  ...
                  <div className="d-flex align-items-end justify-content-center ">
                    ...
                    <span className="fw-bold ms-2">{book.soldQuantity}</span>
                  </div>
                </div>
                <div className="price">
                ...
                <div className="d-flex align-items-center mt-3">
                  ...
                  <SelectQuantity
                    ...
                    reduce={reduce}
                  />
                  <span className="ms-4">{book.quantity} sản phẩm có sẵn</span>
                </div>
